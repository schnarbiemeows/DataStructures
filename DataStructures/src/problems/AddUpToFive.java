...
public class AddUpToFive {
	...
	public static void main(String[] args) {
		// lets say you have a list of integers
		// find all pairs that add up to the number 5(or other number)
		// this solution is O(2n) with code to handle the special situation
		// of pairs of TOTAL/2
		// also eliminates duplicates
		// also, does not require ordering of the list!
		
		// int[] intArray = {20,35,-15,7,55,1,-22,3,3,3,6,0,6,6,-1006,1012,1012,-1006,-1006};
		...
		// go through the list and put its value in the cell located at the paired location, TOTAL-item
		...
		// finally, go through the list one more time, looking in the map for an entry for each key
		for(int item : intArray) {
			// O(n) loop
			Integer key = new Integer(item);
